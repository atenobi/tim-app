...
// constants
import { navLinksLangs } from "./constants/navManuLinksArr";
import { socialMediaArr } from "./constants/socialMedia";
...
function App() {
  ...
  return (
    <div className="main__container flex">
      <NavBar linksArr={navLinksLangs[lang].arr} />
      
      <button onClick={switchLang} className="lang-switch__button">
        {navLinksLangs[lang].lang}
      </button>

      <SocialMediaBar socialArr={socialMediaArr}/>
      <h3>
